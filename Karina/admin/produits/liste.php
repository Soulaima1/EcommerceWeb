...
<html lang="en">
 ...
 -->
        ...
        <?php if (isset($_GET['delete']) && $_GET['delete']=="ok"){
            print'
            <div class="alert alert-success">
                Produit Supprimée Avec Succees
...
<?php  //php pour afficher les produits
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group" >
        <textarea name="description" id="description" class="form-control" placeholder="description de la produit..."></textarea>
        ...
        <div class="form-group">
           ...
           print'<option value="'.$c['id'].'">'.$c['nom'].'</option>';//voir code source
           ?> 
           ...
           <div class="form-group">
            <input type="number" name="quantite" class="form-control" placeholder="Taper la quantité de produit...">
