		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="images/karina.jpg" alt="IMG-LOGO">
					</a>
  ...
  if (isset($_SESSION['nom'])) {
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/35.jpg);">
...
with high quality								</h2>
							</div>
								
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="produits.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
				...
				<div class="item-slick1" style="background-image: url(images/37.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div aligne="right">
				<div class="item-slick1" style="background-image: url(images/39.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
					...
					<?php //php start
print '<div class="sec-banner bg0 p-t-80 p-b-50">
        <div class="container">
          <div class="row">';
foreach($categories as $categorie){
    print '<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
            <div class="block1 wrap-pic-w">
			<img class="banner-image" src="images/'.$categorie['image'].'" alt="IMG-BANNER">
			<a href="produitsParCatgories.php?categorie='.$categorie['id'].'" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">'.$categorie['nom'].'</span>
                  <span class="block1-info stext-102 trans-04">'.$categorie['description'].'</span>
                </div>
        ...
        <div class="filter-col2 p-r-15 p-b-27">
            ...
            <ul>
                ...
                <form action="#product" method="GET">
					...
					<button type="submit" class="filter-link stext-106 trans-04">0-5DT</button>
				</form>
				</li>
				<li class="p-b-6">
                <form action="#product" method="GET">
					<input type="hidden" name="prix" value="5-20">
					<button type="submit" class="filter-link stext-106 trans-04">5DT-20DT</button>
				</form>
				</li>
                ...
                <form action="#product" method="GET">
					...
					<button type="submit" class="filter-link stext-106 trans-04">20DT-50DT</button>
				</form>
				</li>
                ...
                <form action="#product" method="GET">
					...
					<button type="submit" class="filter-link stext-106 trans-04">50DT-100DT</button>
				</form>
				</li>
                ...
                <form action="#product" method="GET">
					...
					<button type="submit" class="filter-link stext-106 trans-04">100DT-150DT</button>
				</form>
				</li>
...
if (isset($id_p)) {
  ...
  $volumes = getVolume($id_p); 
  $sous_images=getSousImage($id_p); 
				...
				<div class="row">
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									...
									<div class="item-slick3" data-thumb="images/<?php echo $p['image']; ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="images/<?php echo $p['image']; ?>" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/<?php echo $p['image']; ?>">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<span class="mtext-106 cl2"  id="prixAffiche">
							<?php foreach($volumes as $volume): ?>

							<?php echo $volume['prix']; ?>
							<?php endforeach; ?>
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2" name="time" onchange="updatePrice(this)">
												<option>Choose an option</option>
												<?php foreach($volumes as $volume): ?>
												<option value="<?php echo $volume['ml']; ?>">
													<?php echo $volume['ml']?> ml
												</option>
												<?php endforeach; ?>
											</select>
