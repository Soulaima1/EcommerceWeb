...
} else if (isset($_GET['prix']) && isset($_GET['categorie'])) {
    $prix = $_GET['prix'];
    $categorieId = $_GET['categorie'];

    switch ($prix) {
        case '0-5':
            $produits = getProductsByPriceRange(0, 5000, $categorieId);
            break;
        case '5-20':
            $produits = getProductsByPriceRange(5000, 20000, $categorieId);
            break;
        case '20-50':
            $produits = getProductsByPriceRange(20000, 50000, $categorieId);
            break;
        case '50-100':
            $produits = getProductsByPriceRange(50000, 100000, $categorieId);
            break;
        case '100-150':
            $produits = getProductsByPriceRange(100000, 150000, $categorieId);
            break;
        case 'tous':
            $produits = getALLProductsCategorie($categorieId);
            break;
        default:
            // Gérer une valeur de prix invalide
            break;
    }
  ...
  <form action="produitsParCatgories.php" method="GET">
    ...
    <button type="submit" class="filter-link stext-106 trans-04">0DT-5DT</button>
                ...
                <form action="#product" method="GET">
					...
					<button type="submit" class="filter-link stext-106 trans-04">150DT-200DT</button>
				</form>
				</li>
